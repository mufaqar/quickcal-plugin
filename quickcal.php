...
// Booked Updates
$value = (INT) get_option('quickcal_update_check');

if(empty($value) || time() - $value>(12*3600)){
    //check after 12 hours
    update_option('quickcal_update_check', time());
	...
	class quickcal_plugin {
		...
		static function plugin_settings() {
			$plugin_options = array(
				...
				'booked_dont_allow_user_cancellations',
                                'booked_dont_allow_user_changes',
		...
		**********************/
		...
		public function front_end_scripts() {
			...
			wp_enqueue_script('booked-tooltipster', QUICKCAL_PLUGIN_URL . '/assets/js/tooltipster/js/jquery.tooltipster.min.js', array(), '3.3.0', true);
			wp_register_script('booked-functions', QUICKCAL_PLUGIN_URL . '/assets/js/functions.js', array(), filemtime(QUICKCAL_PLUGIN_DIR . '/assets/js/functions.js'), true);
		...
		public static function front_end_styles() {
			...
			wp_enqueue_style('booked-animations', QUICKCAL_PLUGIN_URL . '/assets/css/animations.css', array(), QUICKCAL_VERSION);
                        ...
                        wp_enqueue_style('booked-css', QUICKCAL_PLUGIN_URL . '/dist/booked.css', array(), filemtime(QUICKCAL_PLUGIN_DIR . '/dist/booked.css'));
